			...
			<div class="banner-text agileinfo"> 
				...
				<div class="tab-content">
					<div class="tab-pane active" id="horizontal-form">
						<form class="form-horizontal" action="UServiceServlet" method="post">
							...
							<div class="col-sm-8">
                                                            <input type="text" class="form-control1" name="status" id="status" readonly="readonly" value="Pending">
							</div>
                                                        </div>
