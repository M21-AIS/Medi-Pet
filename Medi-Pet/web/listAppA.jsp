	...
	<div class="w3ls-banner jarallax">
		<div class="w3lsbanner-info">
			...
			<div class="banner-text agileinfo"> 
                                ...
                                <h1><center>Appointment Information</center></h1>
                                <br><br>
                              <table class="w3-table w3-bordered">
                                ...
                                <c:forEach items="${apps}" var="app">
                                    ...
                                    <td><a href="AppointmentServletA?action=edit&appNo=<c:out value="${app.appNo}"/>">Edit</a></td>
                                    <td><a href="AppointmentServletA?action=delete&appNo=<c:out value="${app.appNo}"/>">Delete</a></td>
                                    </tr>
                                </c:forEach>
                                </tr>
                                ...
                                <br><br>
                                <center><button type="submit" class="button"><a href="AppointmentServletA?action=insert">Set Appointment</a></button></center>
                                </div>
