			...
			<div class="banner-text agileinfo"> 
                              ...
                              <table class="w3-table-all w3-hoverable">
                                ...
                                <c:forEach items="${pets}" var="pet">
                                    ...
                                    <td><a href="UPetServlet?action=edit&petId=<c:out value="${pet.petid}"/>">Edit</a></td>
                                    </tr>
                                </c:forEach>
                                </tr>
                                ...
                                <br><br>
                                <center><button type="submit" class="button"><a href="UPetServlet?action=insert">Add Pet</a></button></center>
                                </div>
