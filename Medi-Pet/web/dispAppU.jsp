	...
	<div class="w3ls-banner jarallax">
		<div class="w3lsbanner-info">
			...
			<div class="banner-text agileinfo"> 
                                ...
                                <br><br>
                                <form action="AppointmentServletU">
                              <table class="w3-table w3-bordered">
                                <thead>
                                  <tr class="w3-grey">
                                    <th>Full Name : <input type="text" name="fullname" id="fullname"</td></th>
                                  </tr>
                                </thead>
                                
                                <center><input type="submit" class="button" name="submit" value="Enter"/></center>
