...
public class AServiceServlet extends HttpServlet {
    private static final long serialVersionUID = 1L;
    private static String INSERT_OR_EDIT = "/serviceA.jsp";
    private static String LIST_SERVICE = "/listServiceA.jsp";
    private ServiceDAO dao;

    public AServiceServlet() {
        super();
        dao = new ServiceDAO();
    }
